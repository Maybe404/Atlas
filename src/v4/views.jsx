// Atlas v2 reader views: Reader (full iframe), SpaceIndex (card grid)
const _D = window.ATLAS_DATA;
const _I = window.I2;
...
window.SpaceIndexView2 = SpaceIndexView;
...
window.SpaceChipPicker = SpaceChipPicker;
  ...
  return (
    <div className="main-card">
      <div className="main-scroll">
        ...
        <window.AnimatedScrollList className="doc-list-scroll">
          {filtered.map(doc => {
            const author = _D.members.find(m => m.id === doc.author);
            return (
...
window.AdminDocsView2 = AdminDocsView;
