// Atlas v2 admin views: Upload flow + Settings
const _D2 = window.ATLAS_DATA;
const _I2 = window.I2;
...
window.AdminUploadView2 = AdminUploadView;
...
window.AdminSettingsView2 = AdminSettingsView;
        ...
        <div className="card-body card-body-scroll">
          <window.AnimatedScrollList className="rows-scroll">
            {members.map((m, i) => {
              ...
              return (
                <div key={m.id} className="member-row member-row-v4">
