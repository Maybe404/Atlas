// Atlas v2 dialogs: CmdK, ShareDialog, ToastWrap
const _D3 = window.ATLAS_DATA;
const _I3 = window.I2;
          ...
          {items.docs.length > 0 && (
            <>
              ...
              {items.docs.map(it => {
                const my = idxOf();
                return (
                  <window.AnimatedItem index={my} key={it.id}>
          ...
          {items.cmds.length > 0 && (
            <>
              ...
              {items.cmds.map(c => {
                ...
                return (
                  <window.AnimatedItem index={my} key={c.id}>
                    <div className={"cmdk-item " + (my === idx ? 'active' : '')}
                         onMouseEnter={() => setIdx(my)}
                         onClick={() => {
          ...
          {items.members.length > 0 && (
            <>
              ...
              {items.members.map(m => {
                const my = idxOf();
                return (
                  <window.AnimatedItem index={my} key={m.id}>
                    <div className={"cmdk-item " + (my === idx ? 'active' : '')}
                         onMouseEnter={() => setIdx(my)}>
            ...
            <>
              <div style={{display:'flex', gap: 8, marginBottom: 18}}>
                <input
                  ...
                  list="atlas-members-v2"
                />
                <datalist id="atlas-members-v2">
              ...
              <div className="share-roster">
                <window.AnimatedScrollList className="rows-scroll">
...
window.ShareDialog2 = ShareDialog;
...
window.SpaceManagerDialog = SpaceManagerDialog;
