// Atlas v3 chrome — coral warm-default, folder theme switch, animated tree
...
window.TocList = TocList;
window.READER_TOC = READER_TOC;
...
window.AnimatedScrollList = AnimatedScrollList;
